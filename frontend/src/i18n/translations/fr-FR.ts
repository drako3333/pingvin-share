export default {
  ...
  // END navbar
  // /
  "home.title": "Votre plateforme de partage de fichiers <h>Ustrohosting Share</h>.",
  "home.description": "Partagez et transférez vos fichiers et dossiers instantanément, avec une vitesse maximale et une sécurité totale.",
  "home.bullet.a.name": "Vitesse Ultra Rapide",
  "home.bullet.a.description": "Transférez vos données à la vitesse de votre connexion grâce à notre infrastructure cloud optimisée.",
  "home.bullet.b.name": "Confidentialité Totale",
  "home.bullet.b.description": "Vos fichiers sont stockés de façon sécurisée et ne seront jamais partagés ni consultés par des tiers.",
  "home.bullet.c.name": "Zéro Limite de Taille",
  "home.bullet.c.description": "Envoyez des fichiers ou des dossiers volumineux sans aucune restriction de taille arbitraire.",
  ...
  "account.storage.title": "Espace de stockage",
  "account.storage.used": "utilisé",
  "account.storage.alert.critical.title": "Espace de stockage presque saturé !",
  "account.storage.alert.critical.description": "Vous avez utilisé plus de 95% de votre quota de stockage. Libérez de l'espace ou contactez un administrateur.",
  "account.storage.alert.warning.title": "Espace de stockage bientôt saturé",
  "account.storage.alert.warning.description": "Vous avez dépassé 80% de votre quota de stockage autorisé.",
  ...
  "account.card.security.push.title": "Notifications Push",
  "account.card.security.push.description": "Recevez des notifications en temps réel dans votre navigateur lorsque vos partages sont téléchargés, sur le point d'expirer ou lorsque vos partages inversés sont complétés.",
  "account.card.security.push.label": "Activer les notifications push",
  "account.card.security.push.status.active": "Abonnement actif",
  "account.card.security.push.status.inactive": "Non configuré",
  "account.card.security.push.status.blocked": "Bloqué par le navigateur",
  "account.card.security.push.notSupported": "Les notifications push ne sont pas supportées par votre navigateur.",
  "account.card.security.push.notify.subscribed": "Notifications push activées avec succès !",
  "account.card.security.push.notify.unsubscribed": "Notifications push désactivées.",
  "account.card.security.push.notify.permissionDenied": "Permission refusée par le navigateur.",
  "account.card.security.push.notify.error": "Erreur lors de la configuration des notifications push.",
  ...
  "admin.users.modal.create.custom-quota": "Définir un quota personnalisé",
  "admin.users.modal.create.custom-quota.description": "Spécifier une limite de stockage propre à cet utilisateur",
  "admin.users.modal.create.quota": "Quota de stockage",
  // END /admin/users
  // /admin/shares
  ...
  "upload.notify.cancelled": "Téléversement annulé",
  "upload.cancel-button": "Annuler l'envoi",
  ...
  "upload.dropzone.select-files": "Sélectionner des fichiers",
  "upload.dropzone.select-folder": "Sélectionner un dossier",
  // FileList.tsx
  "upload.filelist.name": "Nom",
  "upload.filelist.size": "Taille",
  "upload.filelist.queued": "En attente...",
  "upload.filelist.failed": "Échec",
  ...
  "upload.modal.accordion.security.burn-after-reading.description": "Ce lien sera détruit automatiquement après la première consultation",
  "share.burn-after-reading.warning": "⚠️ Ce partage sera définitivement détruit après consultation",
  "share.burn-after-reading.description": "Ce partage est configuré en mode « Burn After Reading ». Après votre consultation, il sera automatiquement et définitivement supprimé. Téléchargez vos fichiers maintenant.",
  ...
  "admin.config.notifications.enable-share-email-recipients": "Activer le partage par courriel",
  "admin.config.notifications.enable-share-email-recipients.description": "Autoriser ou non le partage de courriels avec les destinataires. N'activer cette option que si SMTP est activé.",
  "admin.config.notifications.share-recipients-subject": "Sujet d’un partage",
  "admin.config.notifications.share-recipients-subject.description": "Intitulé du courriel envoyé aux destinataires d’un partage.",
  "admin.config.notifications.share-recipients-message": "Message d’un partage",
  "admin.config.notifications.share-recipients-message.description": "Contenu du courriel qui est envoyé aux destinataires du partage. Variables possibles :\n {creator} - Le nom d'utilisateur du créateur du partage\n {creatorEmail} - L'adresse mail du créateur du partage\n {shareUrl} - L'URL du partage\n {desc} - La description du partage\n {expires} - La date d'expiration du partage.\n Ces variables seront remplacées par leur valeur effective.",
  "admin.config.notifications.reverse-share-subject": "Sujet d’un partage inversé",
  "admin.config.notifications.reverse-share-subject.description": "Intitulé du courriel envoyé lorsque quelqu’un a partagé des fichiers depuis votre partage inversé.",
  "admin.config.notifications.reverse-share-message": "Message d’un partage inversé",
  "admin.config.notifications.reverse-share-message.description": "Contenu du courriel envoyé lorsque quelqu’un partage des fichiers depuis votre partage inversé. {shareUrl} sera remplacé par le nom du créateur et l’URL de partage.",
  "admin.config.notifications.reset-password-subject": "Sujet d’une réinitialisation du mot de passe",
  "admin.config.notifications.reset-password-subject.description": "Intitulé du courriel envoyé lorsqu’un utilisateur demande une réinitialisation de son mot de passe.",
  "admin.config.notifications.reset-password-message": "Message de réinitialisation du mot de passe",
  "admin.config.notifications.reset-password-message.description": "Contenu du courriel envoyé lorsqu’un utilisateur demande à réinitialiser son mot de passe. {url} sera remplacé par l’URL de réinitialisation du mot de passe.",
  "admin.config.notifications.invite-subject": "Sujet d’une invitation",
  "admin.config.notifications.invite-subject.description": "Intitulé du courriel envoyé lorsqu’un administrateur invite un utilisateur.",
  "admin.config.notifications.invite-message": "Message d’une invitation",
  "admin.config.notifications.invite-message.description": "Message qui est envoyé lorsqu'un administrateur invite un utilisateur. {url} sera remplacé avec l'URL d'invitation, {email} avec le courriel et {password} avec le mot de passe de l'utilisateur.",
  ...
  "admin.config.share.global-download-rate-limit": "Limitation globale du téléchargement",
  "admin.config.share.global-download-rate-limit.description": "Débit maximal total de téléchargement par seconde. Mettez 0 pour aucune restriction. (Exemples : 1.25 MB/s (Mo/s) ≈ 10 Mbps, 12.5 MB/s (Mo/s) ≈ 100 Mbps, 125 MB/s (Mo/s) ≈ 1 Gbps)",
  "admin.config.share.global-upload-rate-limit": "Limitation globale du téléversement",
  "admin.config.share.global-upload-rate-limit.description": "Débit maximal total de téléversement par seconde. Mettez 0 pour aucune restriction. (Exemples : 1.25 MB/s (Mo/s) ≈ 10 Mbps, 12.5 MB/s (Mo/s) ≈ 100 Mbps, 125 MB/s (Mo/s) ≈ 1 Gbps)",
  "admin.config.share.default-user-quota": "Quota par défaut des utilisateurs",
  "admin.config.share.default-user-quota.description": "Quota de stockage par défaut pour les utilisateurs sans limite personnalisée.",
  "admin.config.notifications.webhook-discord": "Webhook Discord",
  "admin.config.notifications.webhook-discord.description": "URL du Webhook Discord pour recevoir des notifications Markdown stylisées lors de la création de partages.",
  "admin.config.notifications.webhook-slack": "Webhook Slack",
  "admin.config.notifications.webhook-slack.description": "URL du Webhook Slack pour recevoir des notifications stylisées lors de la création de partages.",
  "admin.config.notifications.webhook-telegram-token": "Token de Bot Telegram",
  "admin.config.notifications.webhook-telegram-token.description": "Token API de votre Bot Telegram créé via BotFather (par ex. 123456789:ABCdef...).",
  "admin.config.notifications.webhook-telegram-chat-id": "ID de Chat Telegram",
  "admin.config.notifications.webhook-telegram-chat-id.description": "L'identifiant du canal ou de la conversation privée Telegram recevant les notifications (par ex. -100123456789).",
  ...
  "admin.config.s3.multi-buckets-enabled": "Activer le multi-buckets",
  "admin.config.s3.multi-buckets-enabled.description": "Répartir les fichiers sur plusieurs buckets S3/Wasabi/B2 en fonction de la géolocalisation IP de l'utilisateur.",
  "admin.config.s3.multi-buckets-config": "Configuration multi-buckets",
  "admin.config.s3.multi-buckets-config.description": "Configuration JSON des buckets S3 compatibles supplémentaires avec règles de routage régional.",
  "admin.config.s3.tiering-enabled": "Activer l'auto-tiering SSD vers S3",
  "admin.config.s3.tiering-enabled.description": "Déplacer automatiquement les partages locaux anciens vers le stockage cloud pour libérer de l'espace local.",
  "admin.config.s3.tiering-days": "Seuil de migration (jours)",
  "admin.config.s3.tiering-days.description": "Nombre de jours avant que les partages locaux finalisés ne soient migrés vers le stockage cloud.",
  "admin.config.s3.disable-local-storage": "Désactiver le stockage interne",
  "admin.config.s3.disable-local-storage.description": "Une fois activé, tous les partages et fichiers sont exclusivement stockés sur S3/MinIO. Activer cette option migre automatiquement tous les fichiers locaux vers S3/MinIO en tâche de fond.",
  "admin.config.s3.ssd-security-threshold": "Seuil de Sécurité SSD",
  "admin.config.s3.ssd-security-threshold.description": "Le seuil minimal d'espace disque restant requis sur le SSD local (ex: 100 GB). L'auto-tiering vers S3 transfère automatiquement les fichiers locaux vers le cloud dès que l'espace libre descend sous cette limite.",
  ...
  // Analytics
  "analytics.title": "Statistiques & Analyses",
  "analytics.title-share": "Statistiques & Analyses: {shareName}",
  "analytics.back-to-shares": "Retour à mes partages",
  "analytics.back-to-admin": "Retour à l'administration",
  "analytics.subtitle": "Vue d'ensemble de l'activité de la plateforme, du stockage et du trafic.",
  "analytics.subtitle-share": "Suivi des téléchargements, des visiteurs uniques et de l'origine géographique.",
  "analytics.disk.title": "Stockage Disque Système",
  "analytics.disk.subtitle": "Capacité physique de la partition de données",
  "analytics.disk.free": "{percentage}% Libre",
  "analytics.disk.used-label": "Utilisé",
  "analytics.disk.free-label": "Libre",
  "analytics.disk.total-space": "Espace total",
  "analytics.disk.used-space": "Espace utilisé",
  "analytics.disk.free-space": "Espace libre",
  "analytics.storage.title": "Volume de Stockage des Fichiers",
  "analytics.storage.subtitle": "Espace disque total consommé par les fichiers",
  "analytics.storage.files": "{count} fichiers",
  "analytics.storage.consumed": "Espace consommé par les partages",
  "analytics.storage.average": "Taille moyenne des partages",
  "analytics.card.hosting.title": "Hébergement & Partages",
  "analytics.card.hosting.subtitle": "Aperçu des liens actifs",
  "analytics.card.hosting.total": "Total des partages créés",
  "analytics.card.hosting.active": "Partages actuellement actifs",
  "analytics.card.hosting.expired": "Partages expirés",
  "analytics.card.hosting.today": "Nouveaux partages aujourd'hui",
  "analytics.card.data.title": "Données & Volume",
  "analytics.card.data.subtitle": "Poids des fichiers et répartition",
  "analytics.card.data.total-files": "Total des fichiers hébergés",
  "analytics.card.data.total-size": "Volume total des fichiers",
  "analytics.card.data.average-size": "Taille moyenne par partage",
  "analytics.card.data.password": "Partages sécurisés par mot de passe",
  "analytics.card.members.title": "Membres & Trafic",
  "analytics.card.members.subtitle": "Tendance d'utilisation et visites",
  "analytics.card.members.users": "Utilisateurs enregistrés",
  "analytics.card.members.downloads": "Total des téléchargements",
  "analytics.card.members.downloads-today": "Téléchargements aujourd'hui",
  "analytics.card.members.ratio": "Ratio de téléchargement",
  "analytics.card.members.ratio-value": "{ratio} par partage",
  "analytics.downloads": "Téléchargements",
  "analytics.downloads.subtitle": "Volume total de fichiers récupérés",
  "analytics.visitors": "Visiteurs Uniques",
  "analytics.visitors.subtitle": "Adresses IP distinctes enregistrées",
  "analytics.country": "Top Pays",
  "analytics.country.subtitle": "Origine la plus fréquente",
  "analytics.device": "Top Appareil",
  "analytics.device.subtitle": "Type d'écran le plus utilisé",
  "analytics.devices-browsers": "Appareils & Navigateurs",
  "analytics.device-types": "Types d'appareils",
  "analytics.browsers": "Navigateurs",
  "analytics.locations": "Top Localisations",
  "analytics.count-downloads": "{count} téléchargement(s)",
  "analytics.history": "Historique des Téléchargements",
  "analytics.history.empty": "Aucune activité de téléchargement enregistrée pour le moment.",
  "analytics.table.date": "Date & Heure",
  "analytics.table.file": "Fichier",
  "analytics.table.ip": "IP",
  "analytics.table.country": "Pays",
  "analytics.table.device": "Appareil",
  "analytics.table.browser": "Navigateur",
  "analytics.file-deleted": "Fichier supprimé",
  "analytics.zip-complete": "Archive ZIP complète",
  "analytics.unknown": "Inconnu",
  "analytics.logs-audit": "Logs d'audit",
  "analytics.resume.title": "Reprendre le téléversement ?",
  "analytics.resume.description": "Un téléversement précédent a été interrompu. Souhaitez-vous reprendre là où il s'est arrêté ?",
  "analytics.resume.confirm": "Oui, reprendre",
  "analytics.resume.cancel": "Non, recommencer",
  "analytics.upload-speed": "Vitesse de téléversement",
  "analytics.time-remaining": "Temps restant",
  "analytics.shares.totals": "Partages Totaux",
  "analytics.shares.views": "Visiteurs Totaux",
  "analytics.shares.totalsize": "Taille Totale",
  "analytics.shares.averagesize": "Taille Moyenne",
  "upload.modal.completed.download-qr-png": "Télécharger le QR Code (PNG)",
  "upload.modal.completed.share-whatsapp": "Partager sur WhatsApp",
  "upload.modal.completed.share-telegram": "Partager sur Telegram",
  "upload.modal.completed.share-email": "Partager par courriel",
  "upload.modal.completed.share-title-email": "Fichier partagé - Ustrohosting Share",
  "upload.modal.completed.share-body-email": "Bonjour,\n\nVoici un lien pour télécharger les fichiers partagés :\n{link}\n\nCordialement,\nUstrohosting Share"
};