export default {
  ...
  "admin.config.share.global-download-rate-limit.description": "Débit maximal total de téléchargement par seconde (en octets). Mettez 0 pour aucune restriction.",
  "admin.config.share.global-upload-rate-limit": "Limitation globale du téléversement",
  "admin.config.share.global-upload-rate-limit.description": "Débit maximal total de téléversement par seconde (en octets). Mettez 0 pour aucune restriction.",
  ...
  "admin.config.share.webhook-discord": "Webhook Discord",
  "admin.config.share.webhook-discord.description": "URL du Webhook Discord pour recevoir des notifications Markdown stylisées lors de la création de partages.",
  "admin.config.share.webhook-slack": "Webhook Slack",
  "admin.config.share.webhook-slack.description": "URL du Webhook Slack pour recevoir des notifications stylisées lors de la création de partages.",
  "admin.config.share.webhook-telegram-token": "Token de Bot Telegram",
  "admin.config.share.webhook-telegram-token.description": "Token API de votre Bot Telegram créé via BotFather (par ex. 123456789:ABCdef...).",
  "admin.config.share.webhook-telegram-chat-id": "ID de Chat Telegram",
  "admin.config.share.webhook-telegram-chat-id.description": "L'identifiant du canal ou de la conversation privée Telegram recevant les notifications (par ex. -100123456789).",
