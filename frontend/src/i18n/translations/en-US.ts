export default {
  ...
  // Analytics
  "analytics.title": "Statistics & Analytics",
  "analytics.title-share": "Statistics & Analytics: {shareName}",
  "analytics.back-to-shares": "Back to my shares",
  "analytics.back-to-admin": "Back to administration",
  "analytics.subtitle": "Overview of platform activity, storage, and traffic.",
  "analytics.subtitle-share": "Track downloads, unique visitors, and geographic origin.",
  "analytics.disk.title": "System Disk Storage",
  "analytics.disk.subtitle": "Physical capacity of the data partition",
  "analytics.disk.free": "{percentage}% Free",
  "analytics.disk.used-label": "Used",
  "analytics.disk.free-label": "Free",
  "analytics.disk.total-space": "Total space",
  "analytics.disk.used-space": "Used space",
  "analytics.disk.free-space": "Free space",
  "analytics.storage.title": "File Storage Volume",
  "analytics.storage.subtitle": "Total disk space consumed by files",
  "analytics.storage.files": "{count} Files",
  "analytics.storage.consumed": "Space consumed by shares",
  "analytics.storage.average": "Average share size",
  "analytics.card.hosting.title": "Hosting & Shares",
  "analytics.card.hosting.subtitle": "Active links overview",
  "analytics.card.hosting.total": "Total shares created",
  "analytics.card.hosting.active": "Currently active shares",
  "analytics.card.hosting.expired": "Expired shares",
  "analytics.card.hosting.today": "New shares today",
  "analytics.card.data.title": "Data & Volume",
  "analytics.card.data.subtitle": "Files weight and distribution",
  "analytics.card.data.total-files": "Total hosted files",
  "analytics.card.data.total-size": "Total files volume",
  "analytics.card.data.average-size": "Average size per share",
  "analytics.card.data.password": "Password secured shares",
  "analytics.card.members.title": "Members & Traffic",
  "analytics.card.members.subtitle": "Usage trend and visits",
  "analytics.card.members.users": "Registered users",
  "analytics.card.members.downloads": "Total downloads",
  "analytics.card.members.downloads-today": "Downloads today",
  "analytics.card.members.ratio": "Download ratio",
  "analytics.card.members.ratio-value": "{ratio} per share",
  "analytics.downloads": "Downloads",
  "analytics.downloads.subtitle": "Total volume of retrieved files",
  "analytics.visitors": "Unique Visitors",
  "analytics.visitors.subtitle": "Distinct IP addresses registered",
  "analytics.country": "Top Country",
  "analytics.country.subtitle": "Most frequent origin",
  "analytics.device": "Top Device",
  "analytics.device.subtitle": "Most used screen type",
  "analytics.devices-browsers": "Devices & Browsers",
  "analytics.device-types": "Device types",
  "analytics.browsers": "Browsers",
  "analytics.locations": "Top Locations",
  "analytics.count-downloads": "{count} download(s)",
  "analytics.history": "Download History",
  "analytics.history.empty": "No download activity recorded yet.",
  "analytics.table.date": "Date & Time",
  "analytics.table.file": "File",
  "analytics.table.ip": "IP",
  "analytics.table.country": "Country",
  "analytics.table.device": "Device",
  "analytics.table.browser": "Browser",
  "analytics.file-deleted": "Deleted File",
  "analytics.zip-complete": "Full ZIP Archive",
  "analytics.unknown": "Unknown",
  "analytics.logs-audit": "Audit logs",
  "analytics.resume.title": "Resume upload?",
  "analytics.resume.description": "A previous upload was interrupted. Would you like to resume where it left off?",
  "analytics.resume.confirm": "Yes, resume",
  "analytics.resume.cancel": "No, restart",
  "analytics.upload-speed": "Upload speed",
  "analytics.time-remaining": "Time remaining",
  "analytics.shares.totals": "Total Shares",
